...
- [Chapter 4 | System Design](#chapter-4--system-design)
  ...
  - [4.2 System Architecture](#42-system-architecture)
    ...
    - [4.2.4 Deployment Diagram](#424-deployment-diagram)
    - [4.2.5 Persistent Data Management](#425-persistent-data-management)
    - [4.2.6 Database Design](#426-database-design)
    - [4.2.7 Entity Relationship Diagram](#427-entity-relationship-diagram)
    - [4.2.8 Access Control](#428-access-control)
